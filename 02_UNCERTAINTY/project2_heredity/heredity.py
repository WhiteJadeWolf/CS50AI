...
PROBS = {
    ...
    "gene": {  # if we know nothing about the person's parents
        2: 0.01,
        1: 0.03,
        0: 0.96
    },
    ...
    # Mutation probability (gene to no gene and vice versa, while being passed on)
    "mutation": 0.01
}
...
def inherit(parent, one_gene, two_genes):
    """ helper function to calculate probability of parent giving a copy of the gene to the child """
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for truth_value in probabilities[person]["trait"]:
            probabilities[person]["trait"][truth_value] /= total_trait
        for count in probabilities[person]["gene"]:
            probabilities[person]["gene"][count] /= total_gene
