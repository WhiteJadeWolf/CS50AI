...
class Minesweeper():
    ...
    def is_mine(self, cell):
        i, j = cell
        return self.board[i][j] # True for Mine, False for Safe
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # mark the cell as safe, updating any sentences that contain the cell as well
        self.mark_safe(cell)
        ...
        adjusted_count = count - flagged_mine_count
    ...
    def update_knowledge(self):
        """function to update the AI knowledge base to mark new safes and new mines as per current knowledge."""
        keep_going = True # flag variable
        
        # If, based on any of the sentences in self.knowledge, new cells can be marked as safe or as mines, then do it.
        while(keep_going):
            keep_going = False
            new_mines = set()
            new_safes = set()
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    if sentence1 == sentence2:
                        continue
                    if sentence1.cells.issubset(sentence2.cells) and sentence1.cells:
    ...
    def make_random_move(self):
        ...
        l = list(all_cells - self.moves_made - self.mines)
        if l:
