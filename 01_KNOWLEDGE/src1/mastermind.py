...
# RED BLUE YELLOW GREEN - answer - 4

# RED BLUE GREEN YELLOW - 1st Guess - 2

knowledge.add(Or(
    And(Symbol("red0"), Symbol("blue1"), Not(Symbol("green2")), Not(Symbol("yellow3"))),   # adding the knowledge permutation that 2 colors are correctly placed
...
knowledge.add(And(             # adding the knowledge that the guess "BLUE RED GREEN YELLOW" is incorrect
    Not(Symbol("blue0")),
    Not(Symbol("red1")),
    Not(Symbol("green2")),
    Not(Symbol("yellow3"))
